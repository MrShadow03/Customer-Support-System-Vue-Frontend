...
<div id="kt_app_sidebar" class="app-sidebar flex-column print-display-none" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="#" class="d-flex mt-3">
            <img alt="Logo" src="https://i.pravatar.cc/40"
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <RouterLink class="menu-link" :to="{ name: 'dashboard' }" :class="{ 'active': isActive('dashboard') }">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <RouterLink class="menu-link" :to="{ name: 'profile' }" :class="{ 'active': isActive('profile') }">
                        <span class="menu-icon">
    ...
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <form action="#" onclick="this.submit()" method="POST"
